...
\definecolor{statusgood}{RGB}{0,128,0}
...
\begin{table}[H]
    ...
    \begin{tabular}{|l|l|c|c|l|}
        ...
        \hline
        \textbf{Liquidity} & Current Ratio & 1.72 & 1.50 & \textcolor{statusgood}{Above} \\
        \hline
        \multirow{3}{*}{\textbf{Profitability}} & Gross Profit Ratio & 35.2\% & 32.0\% & \textcolor{statusgood}{Above} \\
        & Operating Profit Ratio & 11.8\% & 10.5\% & \textcolor{statusgood}{Above} \\
        & Net Profit Ratio & 7.25\% & 6.5\% & \textcolor{statusgood}{Above} \\
        \hline
        \multirow{3}{*}{\textbf{Returns}} & ROE & 17.12\% & 15.0\% & \textcolor{statusgood}{Above} \\
        & ROCE & 22.45\% & 18.0\% & \textcolor{statusgood}{Above} \\
        & ROA & 12.02\% & 10.0\% & \textcolor{statusgood}{Above} \\
        \hline
        \textbf{Solvency} & Debt Equity Ratio & 0.08 & 0.40 & \textcolor{statusgood}{Better} \\
        \hline
